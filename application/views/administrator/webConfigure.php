...
<div class="breadcrumb">
    <ul>
        <li><a href="#">Modulo Web Configuraci&oacute;n</a></li>
        <li></li>
    </ul>
</div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php foreach (($webConfigure ? $webConfigure : array()) as $k) { ?>
                            <tr>
                                <td><?= $k->tittle; ?></td>
                                <td><?= $k->name; ?></td>
                                <td><?= $k->email; ?></td>
                                ...
                                <td><?= $k->url; ?></td>
                                <td>
                                    <button class="btn btn-info btn-icon m-1" type="button" data-toggle="modal" data-id="<?= $k->id; ?>" data-target=".data_edit">
...
<!-- ============ Modals ============= -->
<?php require(APPPATH . "views/administrator/modals/webConfigure_edit.php"); ?>
...
<script>
    $('.data_edit').on('show.bs.modal', function(event) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>administrator/webDatatable/' + button.data('id'),
            dataType: 'json',
            success: function(data) {
                modal.find('.modal-body #tittle').val(data.tittle)
