    ...
    <div class="col-lg-12 col-md-12">
        <div class="row">
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card mb-4">
                    <div class="card-body">
                        <h5 class="card-title">Editar Menú: <?php echo $menu->nombre; ?></h5>
                        ...
                        <form method="POST" action="<?php echo base_url('menu/edit/' . $menu->id); ?>">
                            
                            <div class="form-group">
                                <label for="nombre">Nombre <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="nombre" name="nombre" required placeholder="Nombre del menú" value="<?php echo $menu->nombre; ?>">
                            </div>

                            <div class="form-group">
                                <label for="url">URL</label>
                                <input type="text" class="form-control" id="url" name="url" placeholder="Ej: controller/method" value="<?php echo $menu->url; ?>">
                                <small class="form-text text-muted">Dejar vacío si es un menú padre con submenús</small>
                            </div>

                            <div class="form-group">
                                <label for="icon">Icono</label>
                                <input type="text" class="form-control" id="icon" name="icon" placeholder="Ej: fal fa-home" value="<?php echo $menu->icon; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="parent" name="parent">
                                    ...
                                    <?php foreach (($parent_menus ?: []) as $pmenu) { ?>
                                        <?php if (empty($pmenu->parent) && $pmenu->id !== $menu->id): ?>
                                            <option value="<?php echo $pmenu->id; ?>" <?php echo ($menu->parent === $pmenu->id) ? 'selected' : ''; ?>>
                                                <?php echo $pmenu->nombre; ?>
                                            </option>
                                        <?php endif; ?>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="status" name="status" required>
                                    <option value="Activo" <?php echo ($menu->status === 'Activo') ? 'selected' : ''; ?>>Activo</option>
                                    <option value="Inactivo" <?php echo ($menu->status === 'Inactivo') ? 'selected' : ''; ?>>Inactivo</option>
                                </select>
                            </div>

                            <div class="form-group mt-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="i-Yes"></i> Actualizar Menú
                                </button>
